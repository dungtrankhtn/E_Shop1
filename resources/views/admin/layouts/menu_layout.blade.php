...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="F:/MyFolders/PC/Apps/xampp/htdocs/E_Shop/public/admin/css/bootstrap.css" rel="stylesheet" type="text/css" media="all">
    <!-- Custom Theme files -->
    <link href="F:/MyFolders/PC/Apps/xampp/htdocs/E_Shop/public/admin/css/style.css" rel="stylesheet" type="text/css" media="all"/>
    <!--js-->
    <script src="F:/MyFolders/PC/Apps/xampp/htdocs/E_Shop/public/admin/js/jquery-2.1.1.min.js"></script>
    <!--icons-css-->
    <link href="F:/MyFolders/PC/Apps/xampp/htdocs/E_Shop/public/admin/css/font-awesome.css" rel="stylesheet">
    <!--Google Fonts-->
    <link href='//fonts.googleapis.com/css?family=Carrois+Gothic' rel='stylesheet' type='text/css'>
    <link href='//fonts.googleapis.com/css?family=Work+Sans:400,500,600' rel='stylesheet' type='text/css'>
    <!--static chart-->
    <script src="F:/MyFolders/PC/Apps/xampp/htdocs/E_Shop/public/admin/js/Chart.min.js"></script>
    <!--//charts-->
    <!-- geo chart -->
...
<!--scrolling js-->
<script src="F:/MyFolders/PC/Apps/xampp/htdocs/E_Shop/public/admin/js/jquery.nicescroll.js"></script>
<script src="F:/MyFolders/PC/Apps/xampp/htdocs/E_Shop/public/admin/js/scripts.js"></script>
<!--//scrolling js-->
<script src="F:/MyFolders/PC/Apps/xampp/htdocs/E_Shop/public/admin/js/bootstrap.js"> </script>
