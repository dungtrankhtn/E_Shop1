...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="{{asset('admin_matterial/css/bootstrap.css')}}" rel="stylesheet" type="text/css" media="all">
    <!-- Custom Theme files -->
    <link href="{{asset('admin_matterial/css/style.css')}}" rel="stylesheet" type="text/css" media="all"/>
    <!--js-->
    <script src="{{asset('admin_matterial/js/jquery-2.1.1.min.js')}}"></script>
    <!--icons-css-->
    <link href="{{asset('admin_matterial/css/font-awesome.css')}}" rel="stylesheet">
    <!--Google Fonts-->
    <link href='//fonts.googleapis.com/css?family=Carrois+Gothic' rel='stylesheet' type='text/css'>
    <link href='//fonts.googleapis.com/css?family=Work+Sans:400,500,600' rel='stylesheet' type='text/css'>
    <!--static chart-->
    <script src="{{asset('admin_matterial/js/Chart.min.js')}}"></script>
    <!--//charts-->
    <!-- geo chart -->
    ...
    <!-- Chartinator  -->
    <script src="{{asset('admin_matterial/js/chartinator.js')}}" ></script>
    ...
    <!--skycons-icons-->
    <script src="{{asset('admin_matterial/js/skycons.js')}}"></script>
    <!--//skycons-icons-->

    {{--Google Map--}}
    <link rel="stylesheet" type="text/css" href="{{asset('admin_matterial/css/examples.css')}}" />
    <!--js-->
                        ...
                        <ul class="nofitications-dropdown">
                            <li class="dropdown head-dpdn">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="#">
                                            <div class="user_img"><img src="{{asset('admin_matterial/images/p4.png')}}" alt=""></div>
                                    ...
                                    <li class="odd"><a href="#">
                                            <div class="user_img"><img src="{{asset('admin_matterial/images/p2.png')}}" alt=""></div>
                                            <div class="notification_desc">
                                                <p>Lorem ipsum dolor </p>
                                                <p><span>1 hour ago</span></p>
                                            </div>
                                    ...
                                    <li><a href="#">
                                            <div class="user_img"><img src="{{asset('admin_matterial/images/p3.png')}}" alt=""></div>
                                            <div class="notification_desc">
                                                <p>Lorem ipsum dolor</p>
                                                <p><span>1 hour ago</span></p>
                                            </div>
                            ...
                            <li class="dropdown head-dpdn">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="#">
                                            <div class="user_img"><img src="{{asset('admin_matterial/images/p5.png')}}" alt=""></div>
                                            <div class="notification_desc">
                                                <p>Lorem ipsum dolor</p>
                                                <p><span>1 hour ago</span></p>
                                            </div>
...
<!--scrolling js-->
<script src="{{asset('admin_matterial/js/jquery.nicescroll.js')}}"></script>
<script src="{{asset('admin_matterial/js/scripts.js')}}"></script>
<!--//scrolling js-->
<script src="{{asset('admin_matterial/js/bootstrap.js')}}"> </script>
